...
\begin{abstract}
	...
	Această aplicație oferă un mediu pentru a demonstra și ajusta diferite filtre de imagine. Acest
	lucru este realizat prin crearea și utilizarea a două biblioteci, una pentru gestionarea filtrelor,
	bibliotecă ce poate fi continuu extinsă, și una pentru interfața grafică, ce oferă acces la parametrii
	fiecărei funcționalități de procesare, combinarea filtrelor pentru diferite rezultate și vizualizarea
	imaginii finale în timp real.
	...
	acestuia și framework-ul QtFramework, folosit deoarece ușurează configurarea intergeței grafice prin
	crearea de widget-uri imbricate.

	Acest proiect a fost conceput pentru prezentarea unor demonstrații educaționale, în cadrul diferitor cursuri
	aplicative sau conferințe. O componentă semnificativă în realizarea acestei functionalități a fost configurarea
...
\begin{abstract}
	...
	various image filtering and distortion concepts. It does so through the use of a filter library, that
	...
	The project was also designed in a way that it can be used to host educational demonstrations, during
	applied courses or conferences. A key component of this was the configuration centered around a
