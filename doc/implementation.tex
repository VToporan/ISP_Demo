...
to a tree of encapsulated widgets, whose layout can be seen in the following:
...
After each element described in \cref{fig:uiSchema} is implemented and placed into its parent layout, the end
